...
class AnimatorInstructionExtractCurveFromHistory(AnimatorInstructionSlotDependent):
...
class AnimatorInstructionExtractBinoutFromHistory(AnimatorInstructionSlotDependent):
    def __init__(self, parameters):
        super().__init__(parameters)
        self._category = None
        self._function = None
