...
class AnimatorInstructionFollow(AnimatorInstructionSlotDependent):
    ...
    def generate_instruction(self):
        for slot in self._slots:
            ...
            self.add_slot_command(slot, "vie fo3 {}".format("/".join(nodes)))

            if not self._status:
                self.add_slot_command(slot, "vie fof")
