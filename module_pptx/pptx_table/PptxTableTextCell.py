...
class PptxTableTextCell(PptxTableCellBase):
    ...
    def apply_styles(self, cell: _Cell):
        ...
        text_content = PptxTextContent(self._text_content, self._default_cell_style, cell.text_frame)
        text_content.update_styles_input(self._cell_style_input)
        text_content.apply_styles()

    def get_arguments(self):
        self._text_content = self._extractor.get_value("content")
